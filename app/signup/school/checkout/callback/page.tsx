...
// confirmation for the user's own UX only - the webhook
// (app/api/webhooks/paystack/route.ts) is the actual source of truth for
// whether the Subscription/Invoice got created, since a user can land here
// before the webhook has been delivered, or not land here at all (closed
// tab, network blip) even though the charge succeeded.
