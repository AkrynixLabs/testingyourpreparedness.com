...
**Decided/built 2026-08-08** — `/terms` and `/privacy` placeholder pages now exist (confirmed with the user: clearly-labeled, not real legal text). Verified live. See `docs/build-log.md`'s 2026-08-08 entry.
